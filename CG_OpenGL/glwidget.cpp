...
void GLWidget::initializeGL()
{
      ...
      // glEnable(GL_COLOR_MATERIAL);
       ...
       //GLfloat L_Ambiente[4]={0.2,0.2,0.2,1.0};
       GLfloat L_difusa[4]={0.7,0.7,0.7,1.0};
       GLfloat L_especular[4]={0.7, 0.7, 0.7, 1.0};

       GLfloat L1_posicao[]={46,  25, 15, 1.0};
       GLfloat spot1_dir []={0, -1.0, 0.0};


       GLfloat L2_posicao[]={58,15,35, 1.0};
       GLfloat spot2_dir []={0, -1.0, 0.0};

       GLfloat L3_posicao[]={43,15,67, 1.0};
       GLfloat spot3_dir []={0, -1.0, 0.0};

       GLfloat L4_posicao[]={72,15,67, 1.0};
       GLfloat spot4_dir []={0, -1.0, 0.0};
      ...
      // glLightfv(GL_LIGHT3,GL_DIFFUSE,L_difusa);
       //glLightfv(GL_LIGHT3,GL_SPECULAR,L_especular);
       glLightfv(GL_LIGHT3,GL_POSITION,L3_posicao);
      ...
      // glLightf(GL_LIGHT3, GL_QUADRATIC_ATTENUATION, 0.2);
       ...
       glLightfv(GL_LIGHT4,GL_DIFFUSE,L_difusa);
       glLightfv(GL_LIGHT4,GL_SPECULAR,L_especular);
       glLightfv(GL_LIGHT4,GL_POSITION,L4_posicao);
...
void GLWidget::paintGL()
{
    ...
    float pista1[4]={0.3235, 0.3823, 0.4450, 1.0};
    ...
    glMaterialfv(GL_FRONT, GL_AMBIENT,pista1);
    glMaterialfv(GL_FRONT, GL_DIFFUSE,pista1);
    glMaterialfv(GL_FRONT, GL_SPECULAR, pista1);
    glMaterialf  (GL_FRONT, GL_SHININESS, 100.0);
